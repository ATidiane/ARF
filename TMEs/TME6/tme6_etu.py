...
def SVM(data_type=0, epsilon=0.3, kernel='linear',
    ...
    s = svm.SVC(kernel=kernel, probability=probability)
    s.fit(trainx, trainy)
...
def main():
    ...
    for dtype in range(3):
        for j, kernel in enumerate(kernels):
            SVM(data_type=dtype, epsilon=0, kernel=kernel, probability=True,
